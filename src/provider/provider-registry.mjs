...
export function createProviderRegistry({ faultMode = "transport", fetchImpl = globalThis.fetch, audit, evaluationScope } = {}) {
  return new Map([
    ...
    [DEEPSEEK_PROVIDER_ID, new DeepSeekProvider({ fetchImpl, audit, evaluationScope })],
  ]);
}
