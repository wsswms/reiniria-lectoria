...
export class BrokeredDeepSeekResearchAdapter {
  constructor({ credentialPath, modelId, maxOutputTokens, pricing, brokerOptions = {} } = {}) {
    ...
    this.pricing = pricing; this.brokerOptions = brokerOptions;
  }
  ...
  async reason(input) { const fixture = input.fixture ?? {}; const request = { modelId: this.modelId, questions: fixture.questions, evidence: fixture.evidence, maxOutputTokens: this.maxOutputTokens };
