...
import { invokeM5EP1LiteDeepSeek } from "./m5e-p1-lite-deepseek.mjs";
...
try {
  ...
  const response = await invokeM5EP1LiteDeepSeek(envelope.request, { credential: credential(3), audit: auditWriterForDescriptor(4) });
