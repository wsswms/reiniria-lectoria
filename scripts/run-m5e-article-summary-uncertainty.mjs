...
if (!["target-language-v1", "source-language-v2", "abstract-source-v3", "source-only-v4"].includes(promptVariant)) throw new Error("article summary uncertainty variant is invalid");
